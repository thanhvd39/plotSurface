...
% Main Brain Surface Plot GUI Launcher
% This is the primary entry point for the brain plotting system
%
% Organized File Structure:
% - main/         : Core GUI and data generation
% - plotting/     : Brain plotting functions  
% - utils/        : Utility functions (annotations, colormaps, etc.)
