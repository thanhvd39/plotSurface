...
% Fixed version that actually works without errors
    ...
    function setupPaths()
        ...
        if exist(fullfile(current_dir, 'src'), 'dir')
            addpath(genpath(fullfile(current_dir, 'src')));
        end
    ...
    function createSimpleGUI()
        ...
        uicontrol('Style', 'text', ...
                 'String', 'Min Value:', ...
                 'Position', [50, 350, 80, 20], ...
                 'BackgroundColor', get(fig, 'Color'), ...
                 'HorizontalAlignment', 'left');
        
        min_edit = uicontrol('Style', 'edit', ...
                           'String', '-1', ...
                           'Position', [140, 350, 60, 25]);
        
        uicontrol('Style', 'text', ...
                 'String', 'Max Value:', ...
                 'Position', [220, 350, 80, 20], ...
                 'BackgroundColor', get(fig, 'Color'), ...
                 'HorizontalAlignment', 'left');
        
        max_edit = uicontrol('Style', 'edit', ...
                           'String', '1', ...
                           'Position', [310, 350, 60, 25]);
        
        % Auto range checkbox
        auto_range_check = uicontrol('Style', 'checkbox', ...
                                   'String', 'Auto Range', ...
                                   'Position', [400, 350, 100, 25], ...
                                   'Value', 1, ...
                                   'BackgroundColor', get(fig, 'Color'), ...
    ...
    function plotCsvDirect(~, ~)
        ...
        try
            ...
            % Call the GUI-safe plotting function
            if exist('plot_brain_gui_safe', 'file')
